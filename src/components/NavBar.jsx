        ...
        <div className={styles.headerContainer}>
          ...
          <nav className={styles.nav}>
            <ul className={styles.navLinks}>
              <li><Link to="/products" className={styles.navLink}>Shop</Link></li>
          ...
          <div className={styles.utilityLinks}>
            ...
            {isAuthenticated ? (
              <>
                <Link to="/profile" aria-label="Account" title={currentUser?.name || 'Account'} className={styles.iconButton}>
                  <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
              ...
              <Link to="/signin" aria-label="Sign In" title="Sign In" className={styles.iconButton}>
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
                  <path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"></path>
                  <circle cx="12" cy="7" r="4"></circle>
                </svg>
